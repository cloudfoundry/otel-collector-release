...
require (
	code.cloudfoundry.org/otel-collector-release/src/receiver/loggregatorreceiver v0.0.0
...
replace code.cloudfoundry.org/otel-collector-release/src/receiver/loggregatorreceiver => ../receiver/loggregatorreceiver

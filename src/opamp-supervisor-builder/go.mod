module code.cloudfoundry.org/otel-collector-release/src/opamp-supervisor-builder

go 1.24

require (
	github.com/open-telemetry/opentelemetry-collector-contrib/cmd/opampsupervisor v0.134.0
...
require (
	...
	github.com/open-telemetry/opamp-go v0.21.0 // indirect
